...
# 更新 Drupal 核心并安装必要的模块：Simple OAuth 和 Drush
RUN composer require drupal/core-recommended:^11.4     drupal/core-composer-scaffold:^11.4     drupal/core-project-message:^11.4     drupal/simple_oauth:^6.1     drush/drush     --update-with-all-dependencies --no-interaction
