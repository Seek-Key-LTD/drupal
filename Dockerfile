...
RUN composer require drupal/core-recommended:^11.4     drupal/core-composer-scaffold:^11.4     drupal/core-project-message:^11.4     drupal/simple_oauth:^6.1     drupal/fontawesome:^3.0     drupal/redis:^1.11     drupal/smtp:^1.4     drush/drush     --update-with-all-dependencies --no-interaction
